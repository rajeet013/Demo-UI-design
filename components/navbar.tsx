...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-col bg-background text-foreground p-7 border-b border-gray-400 md:p-8 md:items-center md:border-b md:border-b-gray-100 md:dark:border-b-gray-600 mb-10">
      <div className="flex justify-between items-center w-full max-w-7xl mx-auto md:p-6 md:justify-between">
        ...
        <div className="flex items-center 2xl:flex-row 2xl:ml-auto">
          <div className="">
