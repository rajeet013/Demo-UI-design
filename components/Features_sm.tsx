...
export default function Six_features_md() {
  return (
    <div className="grid grid-flow-row gap-4 sm:grid-flow-col mr-80 sm:mr-10 sm:grid-rows-3 w-80 h-80 items-center sm:gap-4 sm:w-140 sm:h-80 md:w-140 md:h-80 sm:justify-center mt-5 sm:-mt-10 md:mt-5 sm:hidden">
